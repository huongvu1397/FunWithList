...
class OpenCVActivity : AppCompatActivity(), View.OnTouchListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mOpenCvCameraView =
            findViewById<CameraBridgeViewBase>(R.id.color_blob_detection_activity_surface_view)
    ...
    override fun onTouch(v: View, event: MotionEvent): Boolean {
        ...
        for((index,value) in mBlobColorHsv!!.`val`.withIndex()){
            mBlobColorHsv!!.`val`[index] = mBlobColorHsv!!.`val`[index] / pointCount
        }
